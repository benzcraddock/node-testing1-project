...
describe('[Exercise 3] findLargestInteger', () => {
  test('[5] returns the largest number in an array of objects { integer: 2 }', () => {
    const input1 =  [{integer: 1}, {integer: 2}, {integer: 3}]
    const input2 =  [{integer: 3}, {integer: 2}, {integer: 5}]
    const input3 =  [{integer: 4}, {integer: 3}, {integer: 2}]
